       ...
       <!-- Sulfur JS File -->
        ...
        <script src="{{asset('styles/js/jquery-migrate-1.2.1.min.js')}}"></script>
        <script src="{{asset('styles/js/owl.carousel.min.js')}}"></script>
        <script src="{{asset('styles/js/jquery.appear.js')}}"></script>
        <script src="{{asset('styles/js/jquery.fitvids.js')}}"></script>
        <script src="{{asset('styles/js/jquery.nicescroll.min.js')}}"></script>
        <script src="{{asset('styles/js/lightbox.min.js')}}"></script>
        <script src="{{asset('styles/js/count-to.js')}}"></script>
        <script src="{{asset('styles/js/styleswitcher.js')}}"></script>
